...
class TimeSeries:
    ...
    def __init__(self, df, price_type, ticker, frequency):
    ...
    def get_regimes(self):
        ...
        sns.despine(offset=10)
        st.subheader("Historical {} {} {} regimes".format(self.frequency, self.df['ticker'][0], self.price_type))
    ...
    def smoothed_probability(self):
        ...
        st.subheader("Smoothed probability of a low-variance regime for {} {} returns".format(self.frequency, self.df['ticker'][0]))
        st.line_chart(res_kns.smoothed_marginal_probabilities[0])
        
        st.subheader("Smoothed probability of a medium-variance regime for {} {} returns".format(self.frequency, self.df['ticker'][0]))
        st.line_chart(res_kns.smoothed_marginal_probabilities[1])
        
        st.subheader("Smoothed probability of a high-variance regime for {} {} returns".format(self.frequency, self.df['ticker'][0]))
